  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center border-b-[3px] border-[#059669] pb-4 mb-6">
        <div>
          <h1 className="text-xl font-black text-gray-900 tracking-tight">GREEN PROJECTS EXHIBITIONS & CONFERENCES</h1>
          <h2 className="text-lg text-[#059669] font-black arabic-support tracking-tight">قرين بروجكتس لتنظيم المعارض والمؤتمرات</h2>
        </div>
      ...
      <div className="grid grid-cols-2 gap-12 mt-16 pt-8 border-t-[3px] border-[#059669]/20 text-center">
        ...
        <div className="relative">
          ...
          <p className="text-sm font-semibold">Green Projects for Exhibitions & Conferences</p>
