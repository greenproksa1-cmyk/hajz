            ...
            <div className={`flex-1 text-center ${isRTL ? 'lg:text-right' : 'lg:text-left'} z-20`}>
              ...
              >
                ...
                <span className="text-xs sm:text-sm text-blue-100 font-bold uppercase tracking-wider">
                  {isRTL ? 'تنظيم وإدارة المعارض والمؤتمرات | قرين بروجكتس' : 'Exhibitions & Conferences Management | Green Projects'}
                </span>
              </motion.div>
              ...
              >
                {isRTL ? (
                  <>منصة حجز الأجنحة<br /><span className="bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">قرين بروجكتس</span></>
                ) : (
                  <>Exhibition Booking<br /><span className="bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">Green Projects</span></>
                )}
              </motion.h1>
              ...
              >
                {isRTL 
                  ? 'المنصة المتكاملة لحجز الأجنحة والمساحات في أرقى المعارض والمؤتمرات. اختر جناحك المناسب وفعّل حضور علامتك التجارية بكل سهولة.'
                  : 'The integrated platform for reserving booths and spaces in top exhibitions and conferences. Choose your ideal booth and elevate your brand presence.'}
              </motion.p>
              ...
              >
                ...
                >
                  ...
                  {isRTL ? 'احجز جناحك الآن' : 'Book Booth Now'}
                </Button>
                <Button
                  variant="outline"
                  size="lg"
              ...
              >
                <StatItem value="500+" label={isRTL ? "عارض وشركة" : "Exhibitors"} icon={<Building2 className="w-4 h-4 text-blue-400 mb-1" />} />
                <StatItem value="40+" label={isRTL ? "معرض وفعالية" : "Exhibitions"} icon={<Globe className="w-4 h-4 text-blue-400 mb-1" />} />
                <StatItem value="50K+" label={isRTL ? "زائر ومستثمر" : "Visitors"} icon={<Star className="w-4 h-4 text-blue-400 mb-1" />} />
              </motion.div>
            </div>
              ...
              >
                  ...
                  <div className={`absolute bottom-8 ${isRTL ? 'right-8' : 'left-8'} flex items-center gap-3 bg-white/10 backdrop-blur-xl border border-white/20 p-4 rounded-2xl shadow-2xl`}>
                     ...
                     <div>
                        ...
                        <p className="text-white/60 text-[10px] uppercase tracking-widest">{isRTL ? 'مساحات مميزة' : 'Premium Spaces'}</p>
                     </div>
                  </div>
               </motion.div>
        ...
        <div className="relative container max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto leading-relaxed">
              {isRTL 
                ? 'استثمر في حضورك واختر الباقة التي تمنح علامتك التجارية القوة والتأثير اللازم في مختلف المعارض والفعاليات.' 
                : 'Invest in your presence and choose the package that gives your brand the power and impact in exhibitions and events.'}
            </p>
          </motion.div>
