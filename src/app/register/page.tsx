    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-50 py-12">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-gray-500">سجل الآن لتبدأ رحلتك في حجز الأجنحة والمعارض مع قرين بروجكتس</p>
        </div>
        ...
        <form onSubmit={onSubmit} className="space-y-4" dir="rtl">
          ...
          <div className="space-y-1.5">
             <Label htmlFor="password" title="كلمة المرور" className="text-gray-700 font-medium">كلمة المرور</Label>
